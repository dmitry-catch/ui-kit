...
const { items, loading, hover } = toRefs(props)
...
.DataList__groupLabel[size='extra-small'],
...
.DataList__menuHeader[size='extra-small'] :deep(*),
.DataList__item[size='extra-small'] :deep(*),
.DataList__groupLabel[size='extra-small'] :deep(*),
.DataList__menuFooter[size='extra-small'] :deep(*),
.DataList__empty[size='extra-small'] :deep(*) {
	font-size: var(--design-font-size-footnote);
	line-height: var(--design-line-height-footnote);
	--icon-size: 18px;
}
...
.DataList__groupLabel[size='small'],
...
.DataList__menuHeader[size='small'] :deep(*),
.DataList__item[size='small'] :deep(*),
.DataList__groupLabel[size='small'] :deep(*),
.DataList__menuFooter[size='small'] :deep(*),
.DataList__empty[size='small'] :deep(*) {
	font-size: var(--design-font-size-small);
	line-height: var(--design-line-height-small);
	--icon-size: 20px;
}
