...
describe(`Component ${Component.name}`, () => {
	...
	it('it should render correctly with normal props', () => {
	...
	it('it should emits "delete" event when delete button is clicked', () => {
		const file = new File([''], 'file.txt', { type: 'text/plain' })
		const wrapper = mount(Default, {
			props: {
				file,
	...
	it('it should emits "upload" event when upload button is clicked', () => {
		const file = new File([''], 'file.txt', { type: 'text/plain' })
		const wrapper = mount(Default, {
			props: {
				file,
	...
	it('it should displays spinner when loading is true', () => {
		const file = new File([''], 'file.txt', { type: 'text/plain' })
		const wrapper = mount(Default, {
			props: {
				file,
