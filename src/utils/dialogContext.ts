import { InjectionKey, App, ref, readonly, computed, Ref, ComputedRef, provide } from 'vue'
import { DialogProps } from '../components/general/Dialog/types.js'
...
export function useDialogProvider(app?: App) {
	...
	} else provide(dialogContext, providedState)
}
